const translations = {
  en: {
    ...
    about: {
      ...
      p3: "In my free time I enjoy cycling around the countryside near Berlin. On weekend rides I explore lakes, quiet country lanes and side roads — it's a time for reflection, fresh impressions and good conversations."
    },
    experience: {
      title: "Experience",
      jobs: [
    ...
    certificates: {
      ...
      items: [
        ...
        {
          name: "<a href=\"https://training.linuxfoundation.org/certification/certified-kubernetes-application-developer-ckad/\" target=\"_blank\" class=\"content-link\">Certified Kubernetes Application Developer</a>",
          issuer: "Cloud Native Computing Foundation"
        },
        {
          name: "<a href=\"https://www.scrum.org/professional-scrum-certifications\" target=\"_blank\" class=\"content-link\">Professional Scrum Product-Owner</a>",
          issuer: "Foundation Level · Scrum.org"
        },
        {
          name: "<a href=\"https://www.scrum.org/professional-scrum-certifications\" target=\"_blank\" class=\"content-link\">Professional Scrum Master</a>",
          issuer: "Advanced Level · Scrum.org"
        },
        {
          name: "<a href=\"https://ce-master.htw-berlin.de/\" target=\"_blank\" class=\"content-link\">Master of Engineering in Computer Engineering</a>",
          issuer: "University of Applied Sciences Berlin"
        }
      ]
    },
    footer: "© 2026 Martin Komischke. All rights reserved."
  },
  ...
  de: {
    ...
    about: {
      ...
      p3: "In meiner Freizeit fahre ich gern mit dem Fahrrad durchs Umland von Berlin. Auf Wochenendtouren erkunde ich Seen, ruhige Feldwege und Nebenstraßen — dabei finde ich Ruhe, neue Eindrücke und gute Gespräche."
    },
    experience: {
      title: "Erfahrung",
      jobs: [
    ...
    certificates: {
      ...
      items: [
        ...
        {
          name: "<a href=\"https://ce-master.htw-berlin.de/\" target=\"_blank\" class=\"content-link\">Diplom-Ingenieur für Technische Informatik</a>",
          issuer: "Hochschule für Technik und Wirtschaft Berlin"
        }
      ]
    },
    footer: "© 2026 Martin Komischke. Alle Rechte vorbehalten."
  }
};
